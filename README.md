...
* [Butterchurn SRGB](https://github.com/ferretwithaberet/butterchurn-srgb), a SignalRGB effect to visualize system sound on RGB components, built by [ferretwithaberet](https://github.com/ferretwithaberet)
